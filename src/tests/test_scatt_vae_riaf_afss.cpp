...
int main(int argc, char* argv[])
{
  ...
  // Define model
  Themis::model_image_vae_interpolated_riaf unscattered_image("vae_model");
  //unscattered_image.set_image_size(128,128);
  Themis::model_visibility_galactic_center_diffractive_scattering_screen image( unscattered_image );
  
  // Read in complex visibility data
  //Themis::data_visibility V_data("./V_im1_seed10_netcal_scanavg_scanavg_f1_tygtd.dat","HH");
  Themis::data_visibility V_data("./V_test.dat","HH");
