...
/*!
  \brief Defines an image model based on the semi-analytic shearing spot models employed in VRT2 with the Johannsen (2013) metric.
  ...
  Parameter list:\n
  - parameters[0] ... Black hole spin parameter (0 to 1).
  ...
  \warning Model requires VRT2 to be installed and it explicilty time dependent. Model assumes one time is passed.
*/
 
class model_image_shearing_spot_johannsen : public model_image
{
 private:
 ...
 public:
  ...
  model_image_shearing_spot_johannsen( double start_obs, double tobs, 
  ...
  virtual ~model_image_shearing_spot_johannsen() {};
