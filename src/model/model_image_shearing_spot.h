...
#ifndef Themis_MODEL_IMAGE_SHEARING_SPOT_H_
#define Themis_MODEL_IMAGE_SHEARING_SPOT_H_
...
class model_image_shearing_spot : public model_image
{
 private:
 ...
 public:
  ...
  model_image_shearing_spot( double start_obs, double tobs, 
  ...
  virtual ~model_image_shearing_spot() {};
