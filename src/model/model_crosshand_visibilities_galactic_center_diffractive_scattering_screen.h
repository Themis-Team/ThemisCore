/*!
  \file model_crosshand_visibilities_galactic_center_diffractive_scattering_screen.h   
  \author Paul Tiede 
  \date August 2019
...
#ifndef Themis_MODEL_CROSSHAND_VISIBILITIES_GALACTIC_CENTER_DIFFRACTIVE_SCATTERING_SCREEN_H_
#define Themis_MODEL_CROSSHAND_VISIBILITIES_GALACTIC_CENTER_DIFFRACTIVE_SCATTERING_SCREEN_H_
...
namespace Themis {
  /*!
    \class model_crosshand_visibilities_galactic_center_diffractive_scattering_screen
  ...
  */
  class model_crosshand_visibilities_galactic_center_diffractive_scattering_screen : public model_crosshand_visibilities 
  {

  public:
    model_crosshand_visibilities_galactic_center_diffractive_scattering_screen(model_crosshand_visibilities& model, 
    ...
    virtual ~model_crosshand_visibilities_galactic_center_diffractive_scattering_screen() {};
    ...
    //! Redefines the crosshand visibilities function since we need to multiply by the scattering kernel
