...
#ifndef THEMIS_MODEL_IMAGE_SLASHED_RING_H_
#define THEMIS_MODEL_IMAGE_SLASHED_RING_H_
...
namespace Themis {
  ...
  */
  class model_image_slashed_ring : public model_image
  {
   private:
   ...
   public:
    ...
    model_image_slashed_ring();
    virtual ~model_image_slashed_ring() {};
    ...
    {
      return "model_image_slashed_ring";
    };
