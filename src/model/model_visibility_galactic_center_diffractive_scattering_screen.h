...
#ifndef Themis_MODEL_VISIBILITY_GALACTIC_CENTER_DIFFRACTIVE_SCATTERING_SCREEN_H_
#define Themis_MODEL_VISIBILITY_GALACTIC_CENTER_DIFFRACTIVE_SCATTERING_SCREEN_H_
...
namespace Themis {
  ...
  */
  class model_visibility_galactic_center_diffractive_scattering_screen : public model_visibility 
  {

    public:
      model_visibility_galactic_center_diffractive_scattering_screen(
      ...
      virtual ~model_visibility_galactic_center_diffractive_scattering_screen() {};
