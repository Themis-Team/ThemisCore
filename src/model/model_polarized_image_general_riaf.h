/*!
  \file model_polarized_image_general_riaf.h
...
#ifndef Themis_MODEL_POLARIZED_IMAGE_GENERAL_RIAF_H_
#define Themis_MODEL_POLZRIZED_IMAGE_GENERAL_RIAF_H_
...
*/
class model_polarized_image_general_riaf : public model_polarized_image
{
 private:
 ...
 public:
  ...
  model_polarized_image_general_riaf(double frequency=230e9, double D=VRT2::VRT2_Constants::D_SgrA_cm);
  virtual ~model_polarized_image_general_riaf() {};
