/*!
  ...
  \author Paul Tiede
  \date  June, 2018
  \brief Header file for SED-fitted RIAF model class with Johannsen metric.
  \details To be added
*/

#ifndef Themis_MODEL_IMAGE_SED_FITTED_RIAF_JOHANNSEN_H_
#define Themis_MODEL_IMAGE_SED_FITTED_RIAF_JOHANNSEN_H_
...
namespace Themis {
  ...
  /*!
    ...
    Broderick et al. (2016). Explicitly uses the Johannsen (2013) metric
  ...
  */  
  class model_image_sed_fitted_riaf_johannsen : public model_image
  {
    private:
      
      //! Generates and returns rectalinear grid of intensities associated
      //! with the RIAF image model in Jy/pixel located at pixels centered 
    ...
    public:
      ...
      virtual ~model_image_sed_fitted_riaf_johannsen() {};
