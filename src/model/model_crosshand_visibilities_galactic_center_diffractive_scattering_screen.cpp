/*!
    \file model_crosshand_visibilities_galactic_center_diffractive_scattering_screen.cpp  
...
model_crosshand_visibilities_galactic_center_diffractive_scattering_screen::model_crosshand_visibilities_galactic_center_diffractive_scattering_screen(
   ...
   _P_phi_func("none", scattering_model, scatt_alpha, _phi0)
{
  ...
  std::cerr << "Scattering your crosshand_visibilities model\n";
...
double model_crosshand_visibilities_galactic_center_diffractive_scattering_screen::Dphi(double u, double v) const
{
...
double model_crosshand_visibilities_galactic_center_diffractive_scattering_screen::Q(double x, double y) const
{
...
model_crosshand_visibilities_galactic_center_diffractive_scattering_screen::_P_phi::_P_phi(std::string axis, std::string model, double alpha, double phi0)
...
double model_crosshand_visibilities_galactic_center_diffractive_scattering_screen::_P_phi::operator()(double phi) const
{
...
void model_crosshand_visibilities_galactic_center_diffractive_scattering_screen::generate_model(std::vector<double> parameters)
{
  _model.generate_model(parameters);
}

void model_crosshand_visibilities_galactic_center_diffractive_scattering_screen::set_mpi_communicator(MPI_Comm comm)
{
  _model.set_mpi_communicator(comm);
}

std::vector< std::complex<double> > model_crosshand_visibilities_galactic_center_diffractive_scattering_screen::crosshand_visibilities(datum_crosshand_visibilities& d, double acc)
{
  std::complex<double> scatt_kernel(std::exp(-0.5*Dphi(d.u/(1+_M),d.v/(1+_M))),0.0);

  std::vector< std::complex<double> > cv = _model.crosshand_visibilities(d,acc);
