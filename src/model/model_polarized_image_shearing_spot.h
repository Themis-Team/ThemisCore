/*!
  \file model_polarized_image_shearing_spot.h
  author Paul Tiede
  \date  March, 2018
...
#ifndef Themis_MODEL_POLARIZED_IMAGE_SHEARING_SPOT_H_
#define Themis_MODEL_POLARIZED_IMAGE_SHEARING_SPOT_H_
...
/*!
  ...
  \details Provides explicit implementation of the model_polarized_image object for the semi-analytic shearing spot models.  There are additional tuning parameters that may impact accuracy, e.g., distance to the image screen, number of rays to produce, etc.  See the appropriate parts of model_polarized_image_shearing_spot.cpp for more.    
  Parameter list:\n
  ...
  - parameters[18] ... Magnetic field pitch angle
...
class model_polarized_image_shearing_spot : public model_polarized_image
{
 private:
 ...
 public:
  ...
  //! Sets model_polarized_image_shearing_spot to generate production images with
 ...
 private:
  ...
  const bool _bkgd_riaf; //!< Specifies whether to include riaf model in radiative transfer scheme.
