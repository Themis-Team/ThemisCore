/*!
  ...
  \author Paul Tiede
  \date  April, 2017
  \brief Header file for creating a movie object for orbiting spot based on model_image_orbiting_spot and Broderick & Loeb 2006.
  \details Creates a series of images i.e. a movie for the orbiting spot model image class. Frames of the movie are selected by using nearest neighbor interpolation. For more details for how the orbiting spot model image class works see model_image_orbiting_spot.h.
*/

#ifndef Themis_MODEL_MOVIE_ORBITING_SPOT_H_
#define Themis_MODEL_MOVIE_ORBITING_SPOT_H_
...
*/  
class model_movie_orbiting_spot : public model_movie<model_image_orbiting_spot>
{
 public:
  ...
  model_movie_orbiting_spot(double start_observation, 
