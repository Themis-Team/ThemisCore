/*!
  \file model_polarized_movie_shearing_spot.h
  \author Paul Tiede
  \date  April, 2017
...
#ifndef Themis_MODEL_POLARIZED_MOVIE_SHEARING_SPOT_H_
#define Themis_MODEL_POLARIZED_MOVIE_SHEARING_SPOT_H_
...
*/  
class model_polarized_movie_shearing_spot : public model_polarized_movie<model_polarized_image_shearing_spot>
{
 public:
  ...
  model_polarized_movie_shearing_spot(double start_observation, 
  ...
  ~model_polarized_movie_shearing_spot();
