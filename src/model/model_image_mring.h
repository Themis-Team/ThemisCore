...
#ifndef THEMIS_MODEL_IMAGE_MRING_H_
#define THEMIS_MODEL_IMAGE_MRING_H_
...
namespace Themis {
  ...
  /*!
    ...
    This model is defined by four parameters:
      ...
      - parameters[1]: <em>R</em> = ring radius.
      - parameters[2,3]: coefficients for the first mode of the ring
      - parameters[4,5]: coefficients for the second mode of the ring
      - ....
      - parameters[1+2N-2,1+2N-1]: coefficients for the last N mode of the ring
  */
  class model_image_mring : public model_image
  {
    private:
    ...
    public:
      ...
      model_image_mring(size_t order);
      virtual ~model_image_mring() {};
      ...
      //! the model expects
      virtual inline size_t size() const { return 2+_order*2; };
