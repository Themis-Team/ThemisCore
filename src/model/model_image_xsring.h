/*!
  ...
  \date  October, 2017
  \brief Header file for the Geometric Slashed Ring Model Image class.
  \details To be added.
*/

#ifndef THEMIS_MODEL_IMAGE_XSRING_H_
#define THEMIS_MODEL_IMAGE_XSRING_H_
...
namespace Themis {
  ...
  /*!
    ...
    This model is defined by four parameters:
      ...
      - parameters[5]: \f$ \phi \f$ = The orientation (in model_image) in radians.
  */
  class model_image_xsring : public model_image
  {
    private:
    ...
    public:
      ...
      //! the model expects
      virtual inline size_t size() const { return 6; };
