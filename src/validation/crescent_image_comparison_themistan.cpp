...
int main(int argc, char* argv[])
{
  ...
  //Initially lets use 2 cpus per likelihood
  DEO.set_cpu_distribution(4,2);
  ...
  DEO.set_output_stream("chain_themistanv6.dat", "state_themistanv6.dat", "sampler_summary_themistanv6.txt");

  //Sets the output for the annealing summary information
  DEO.set_annealing_output("annealing_v6.dat"); 
  ...
  int num_rounds = 2; //number of adaptation rounds.
  ...
  std::vector<double> best_fit = hmc->find_best_fit();
  ...
  */
  //Now lets change the number of tempering levels to 8 and retry after adaptation
  DEO.set_cpu_distribution(8,1);
