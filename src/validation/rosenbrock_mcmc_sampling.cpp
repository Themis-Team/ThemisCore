...
int main(int argc, char* argv[])
{
  ...
  L.push_back(new Themis::likelihood_rosenbrock());
  ...
  int Number_of_chains = 20;      // Number of walkers at each temperature
  int Number_of_temperatures = 20;  // Number of temperatures in the parallel tempering
  ...
  MC_obj.run_sampler(L_obj, Number_of_steps, temp_stride, chi2_stride, 
                     "chain-rosenbrock.dat", "lklhd-rosenbrock.dat", "chi2-rosenbrock.dat",  
