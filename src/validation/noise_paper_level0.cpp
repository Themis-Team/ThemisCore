...
int main(int argc, char* argv[])
{
  ...
  Themis::model_image_symmetric_gaussian model;
  ...
  if (test_type==0) 
  {
    datafile = Themis::utils::global_path("sim_data/NoisePaperData/V_none.dat");
    uncer_ptr = &uncer_none;
  }
  else if (test_type==-1)
  {
    datafile = Themis::utils::global_path("sim_data/NoisePaperData/V_lc.dat");
    uncer_ptr = &uncer_none;
  }
  else if (test_type==1)
  {
  ...
  {
    datafile = Themis::utils::global_path("sim_data/NoisePaperData/V_bpc.dat");
    uncer_ptr = &uncer_none;
  }
  else if (test_type==2)
  {
