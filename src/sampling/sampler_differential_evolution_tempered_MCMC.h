/*!
  ...
  \brief Header file for sampler_differential_evolution_tempered_MCMC class
*/


#ifndef THEMIS_SAMPLER_DIFFERENTIAL_EVOLUTION_TEMPERED_MCMC_H
#define THEMIS_SAMPLER_DIFFERENTIAL_EVOLUTION_TEMPERED_MCMC_H
...
/*! 
  \class sampler_differential_evolution_tempered_MCMC
  ...
  Parallel tempering is optimized by dynamically
...
class sampler_differential_evolution_tempered_MCMC
{
 public:
  ...
  ~sampler_differential_evolution_tempered_MCMC();
  ...
  */
  ...
  /*!
    \brief Function to set the parameters of the tempering schedule.  t0 is the halving-time, nu is the origional tempering value, which should be bounded by unity.
  */
