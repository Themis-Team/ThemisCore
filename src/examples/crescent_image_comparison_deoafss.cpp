...
int main(int argc, char* argv[])
{
  ...
  //Output the model tag for easy integration with ThemisPy
  intrinsic_image.write_model_tag_file();
  ...
  DEO.get_sampler()->set_adaptation_parameters(nadapt, save_warmup);
