/***********************************************************/
/*** Implements unpolarized thermal synchrotron emission ***/
/*                                                         */
/* Notes:                                                  */
...
// Only include once
#ifndef VRT2_RT_UNPOLARIZED_THERMAL_SYNCHROTRON_H
#define VRT2_RT_UNPOLARIZED_THERMAL_SYNCHROTRON_H
...
namespace VRT2 {
class RT_UnpolarizedThermalSynchrotron : public RadiativeTransfer
{
 public:
  // Constructor
  RT_UnpolarizedThermalSynchrotron(Metric& g,
			ElectronDensity& ne, Temperature& Te, AccretionFlowVelocity& u, MagneticField& B);
  RT_UnpolarizedThermalSynchrotron(const double y[], Metric& g,
			ElectronDensity& ne, Temperature& Te, AccretionFlowVelocity& u, MagneticField& B);
  RT_UnpolarizedThermalSynchrotron(FourVector<double>& x, FourVector<double>& k, Metric& g,
			ElectronDensity& ne, Temperature& Te, AccretionFlowVelocity& u, MagneticField& B);
  virtual ~RT_UnpolarizedThermalSynchrotron() { };
