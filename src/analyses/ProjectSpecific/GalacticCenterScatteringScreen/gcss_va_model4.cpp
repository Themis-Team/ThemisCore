...
int main(int argc, char* argv[])
{
  ...
  //V1.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_sgra_MB007_selfcal_scanavg_f3_t7mJy_tygtd.dat"),"HH");
  //V2.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_sgra_MJ001A_selfcal_scanavg_f1_t7mJy_tygtd.dat"),"HH");
  //V3.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_sgra_MJ001B_selfcal_scanavg_f1_t7mJy_tygtd.dat"),"HH");
  //V1.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_sgra_MB007_scanavg_t7mJy_tygtd.dat"),"HH");
  V2.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_sgra_MJ001A_scanavg_t7mJy_tygtd.dat"),"HH");
  V3.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_sgra_MJ001B_scanavg_t7mJy_tygtd.dat"),"HH");

  //V1.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_model3_sym-gauss-default-scatt_MB007_scanavg_t7mJy_tygtd.dat"),"HH");
  V1.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_model4_asym-gauss-default-scatt-ensemble-avg_MB007_scanavg_t7mJy_tygtd.dat"),"HH");
  ...
  // Sim truths
  double sig2fwhm = std::sqrt(8.0*std::log(2.0));
  pstart[0] = 1.0;
  pstart[1] = std::sqrt(2.0/(1.0/(105.0*105.0)+1.0/(140.0*140.0))) * uas2rad/sig2fwhm;
  pstart[2] = 1.0-std::pow(pstart[1]/(140.0*uas2rad/sig2fwhm),2);
  pstart[3] = (180.0-80.0) * M_PI/180.0;
  pstart[7] = 1.38; // alpha
  pstart[8] = std::log10(800e5); // log10( rin in cm )
