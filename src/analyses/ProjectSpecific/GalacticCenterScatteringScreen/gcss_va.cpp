...
int main(int argc, char* argv[])
{
  ...
  V2.add_data(Themis::utils::global_path("gmva_data/SgrA/VM_hops_sgra_MJ001A_selfcal_scanavg_f3_t10mJy_tygtd.dat"),"HH");
  V3.add_data(Themis::utils::global_path("gmva_data/SgrA/VM_hops_sgra_MJ001B_selfcal_scanavg_f3_t10mJy_tygtd.dat"),"HH");
