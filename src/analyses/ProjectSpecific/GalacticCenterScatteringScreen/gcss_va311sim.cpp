...
int main(int argc, char* argv[])
{
  ...
  V1.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_sgra_MB007_selfcal_scanavg_f8_t7mJy_tygtd.dat"),"HH");
  V2.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_sgra_MJ001A_selfcal_scanavg_f8_t7mJy_tygtd.dat"),"HH");
  V3.add_data(Themis::utils::global_path("gmva_data/Simulated/VM_synthetic_sgra_MJ001B_selfcal_scanavg_f8_t7mJy_tygtd.dat"),"HH");
