...
int main(int argc, char* argv[])
{
  ...
  for (size_t index=size_t(istart); index<size_t(iend); index+=8)  // Jump by two 
  {
    // Read in data
    ...
    CP.add_data(cp_file_names[index+2]);
    CP.add_data(cp_file_names[index+3]);
    ...
    VA1_res_name << "VA_residuals_3597_hi_" << std::setfill('0') << std::setw(5) << index << ".d";
    VA2_res_name << "VA_residuals_3597_lo_" << std::setfill('0') << std::setw(5) << index << ".d";
    VA3_res_name << "VA_residuals_3598_hi_" << std::setfill('0') << std::setw(5) << index << ".d";
    VA4_res_name << "VA_residuals_3598_lo_" << std::setfill('0') << std::setw(5) << index << ".d";
    ...
    gc1_name << "gain_corrections_3597_hi_" << std::setfill('0') << std::setw(5) << index << ".d";
    gc2_name << "gain_corrections_3597_lo_" << std::setfill('0') << std::setw(5) << index << ".d";
    gc3_name << "gain_corrections_3958_hi_" << std::setfill('0') << std::setw(5) << index << ".d";
    gc4_name << "gain_corrections_3958_lo_" << std::setfill('0') << std::setw(5) << index << ".d";
    ...
    int Ndof_VM = int(VM1.size()) - int(lva1.number_of_independent_gains()) + int(VM2.size()) - int(lva2.number_of_independent_gains())
      ...
      + int(VM5.size()) - int(lva5.number_of_independent_gains()) + int(VM6.size()) - int(lva6.number_of_independent_gains())
      + int(VM7.size()) - int(lva7.number_of_independent_gains()) + int(VM8.size()) - int(lva8.number_of_independent_gains())
      - int(image.size());
