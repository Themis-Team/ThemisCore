...
int main(int argc, char* argv[])
{
  ...
  for (size_t index=size_t(istart); index<size_t(iend); ++index)
  {
    ...
    */
    ...
    //====linear priors for PA
    // for i=163 images, apply PA prior 288-180=108
    // the range is 288+5-180=113
    //  288-5-180=103
    P.push_back(new Themis::prior_linear(103./180.*M_PI,113/180.*M_PI)); // position angle
    means.push_back(108./180.*M_PI);
    ranges.push_back(3./180.*M_PI);
