...
int main(int argc, char* argv[])
{
  ...
  for (size_t index=size_t(istart); index<size_t(iend); ++index)
  {
    ...
    */
    ...
    // for i=17 images, apply PA prior 288
    // the range is 288+5=293
    //  288-5=283
    P.push_back(new Themis::prior_linear(283./180.*M_PI,293./180.*M_PI)); // position angle
    means.push_back(288./180.*M_PI);
