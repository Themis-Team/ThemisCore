...
int main(int argc, char* argv[])
{
  ...
  std::string visibility_amplitude_data_file=Themis::utils::global_path("eht_data/ER5/Mexico/Processed_1/lo/VM_hops_3598_M87+netcal.d");
  std::string closure_phase_data_file=Themis::utils::global_path("eht_data/ER5/Mexico/Processed_1/lo/CP_hops_3598_M87+netcal.d");
