...
int main(int argc, char* argv[])
{
  ...
  Themis::data_visibility_amplitude VM(Themis::utils::global_path("sim_data/Challenge4/ch4_VA_im2.d"));

  // Read in closure phases data
  Themis::data_closure_phase CP(Themis::utils::global_path("sim_data/Challenge4/ch4_CP_im2.d"));
  ...
  // Run the Sampler                            
  MCMC_obj.run_sampler(L_obj, Number_of_steps, Temperature_stride, Chi2_stride, "Chain-CH4b.dat", "Lklhd-CH4b.dat", "Chi2-CH4b.dat", means, ranges, var_names, restart_flag, out_precision, verbosity);
