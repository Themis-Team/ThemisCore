...
int main(int argc, char* argv[])
{
  ...
  Themis::data_visibility_amplitude VM(Themis::utils::global_path("sim_data/ChallengeJ_wo_shortB/VM_challenge_14_seed_2_simobs_netcal_scanavg_wo_shortB.d"));
  ...
  //Best fit smooth crescent
  means[0] = 1.1556192;
  means[1] = 1.2378965e-10;
  means[2] = 0.0018006874;
  means[3] = 0.058773992;
  means[4] = 2.3649932;
  means[5] = 4.2949012e-11;
  means[6] = 1.4267171e-13;
  means[7] = 0.067159584;
  means[8] = -1.1125934e-18;
  means[9] = 2.1624817e-18;
  ...
  L_obj(means);
  L[0]->output_model_data_comparison("VA_residuals_ns.d");
  L[1]->output_model_data_comparison("CP_residuals_ns.d");
  lva.output_gain_corrections("gain_corrections_ns.d");
  ...
  // Set a checkpoint
  MCMC_obj.set_checkpoint(Ckpt_frequency,"MCMCNS.ckpt");
  
  // Run the Sampler                            
  MCMC_obj.run_sampler(L_obj, Number_of_steps, Temperature_stride, Chi2_stride, "ChainNS.dat", "LklhdNS.dat", "Chi2NS.dat", means, ranges, var_names, restart_flag, out_precision, verbosity);
