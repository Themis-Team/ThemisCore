...
int main(int argc, char* argv[])
{
  ...
  means[0] = 0.76662529;
  means[1] = 1.2163799e-10;
  means[2] = 0.25512621;
  means[3] = 0.6035553;
  means[4] = 2.7855058;
  means[5] = 3.4704781e-11;
  means[6] = 0.18102877;
  means[7] = 2.1398372;
  means[8] = -4.5549765e-18;
  means[9] = -6.1661953e-19;
  means[10] = 0.2629174;
  means[11] = 1.9857795e-11;
  means[12] = 0.89255442;
  means[13] = 3.0889106;
  means[14] = 8.211652e-11;
  means[15] = 2.5589446e-11;
  means[16] = 0.032139143;
  means[17] = 1.0926801e-11;
  means[18] = 0.93335337;
  means[19] = 2.1260283;
  means[20] = 1.1293279e-10;
  means[21] = 2.0222602e-10;
  means[22] = 0.02163238;
  means[23] = 1.7071344e-11;
  means[24] = 0.95192388;
  means[25] = 0.43934462;
  means[26] = -1.4225341e-10;
  means[27] = -2.1504159e-11;
  ...
  L_obj(means);
  L[0]->output_model_data_comparison("VA_residuals_nsb.d");
  L[1]->output_model_data_comparison("CP_residuals_nsb.d");
  lva.output_gain_corrections("gain_correction_nsb.d");
  ...
  // Set a checkpoint
  MCMC_obj.set_checkpoint(Ckpt_frequency,"MCMCNSB.ckpt");
  
  // Run the Sampler                            
  MCMC_obj.run_sampler(L_obj, Number_of_steps, Temperature_stride, Chi2_stride, "ChainNSB.dat", "LklhdNSB.dat", "Chi2NSB.dat", means, ranges, var_names, restart_flag, out_precision, verbosity);
