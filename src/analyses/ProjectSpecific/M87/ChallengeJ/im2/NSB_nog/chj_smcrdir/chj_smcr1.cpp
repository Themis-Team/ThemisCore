...
int main(int argc, char* argv[])
{
  ...
  means[0] = 0.43703395;
  means[1] = 1.0505393e-10;
  means[2] = 0.00062710987;
  means[3] = 0.9670936;
  means[4] = -2.5830468;
  means[5] = 5.3277029e-13;
  means[6] = 0.99925755;
  means[7] = -1.3679196;
  means[8] = 4.0820291e-18;
  means[9] = -1.5739743e-18;
  ...
  Themis::likelihood_visibility_amplitude L_va(VM,intrinsic_image);
