...
int main(int argc, char* argv[])
{
  ...
  //L.push_back(&lva); comented
  Themis::likelihood_visibility_amplitude L_va(VM,image);//changed
  L.push_back(&L_va)//changed
  ...
  //lva.output_gain_corrections("gain_corrections_direct.d");//changed
