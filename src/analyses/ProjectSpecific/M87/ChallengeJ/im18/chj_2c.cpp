...
int main(int argc, char* argv[])
{
  ...
  means[0] = 0.60422244;
  means[1] = 8.7051101e-11;
  means[2] = 0.2224602;
  means[3] = 0.010002424;
  means[4] = 3.0277705;
  means[5] = 3.4427226e-18;
  means[6] = -2.4061496e-18;
  means[7] = 0.71528339;
  means[8] = 1.7741142e-10;
  means[9] = 0.57712088;
  means[10] = 0.29312079;
  means[11] = -2.0485373;
  means[12] = -2.2084243e-12;
  means[13] = -1.8186436e-11;


  ranges[0] = 1e-4;
  ranges[1] = 1e-4*uas2rad;
  ranges[2] = 1e-4;
  ranges[3] = 1e-4;
  ranges[4] = 1e-4;
  ranges[5] = 1e-4*uas2rad;
  ranges[6] = 1e-4*uas2rad;
  ranges[7] = 1e-4;
  ranges[8] = 1e-4*uas2rad;
  ranges[9] = 1e-4;
  ranges[10] = 1e-4;
  ranges[11] = 1e-4;
  ranges[12] = 1e-4*uas2rad;
  ranges[13] = 1e-4*uas2rad;
