/*!
  \file analyses/Challenge2/challenge2_VACP_comparison.cpp
  ...
  \details Fits 1-7 Gaussian models to a set of simulated visibility amplitude and closure phase data following the modeling challenge 2.  Note that this can be compiled to generate an MCMC chain or, having found a good fit, compute the Bayesian evidence.
*/
...
int main(int argc, char* argv[])
{
  ...
  // SNR-limited data
  Themis::data_visibility_amplitude dVM(Themis::utils::global_path("sim_data/Challenge2/Ch2_VMs_SNR.d"));
  Themis::data_closure_phase dCP(Themis::utils::global_path("sim_data/Challenge2/Ch2_CPs_SNR.d"));
